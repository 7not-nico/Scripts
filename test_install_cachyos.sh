...
echo "Would run: echo 'y' | sudo ./cachyos-repo.sh"
echo "Would run: cd -"
echo ""
...
echo "Would run: echo 'y' | yay -S --noconfirm paru"
...
packages=("cachyos-mirror" "rate" "cachyos-kernel-manager" "cachyos-hello" "opencode-bin" "fish" "cachyos-fish-config" "lapce" "zed")
echo "Would run: echo 'y' | paru -S --noconfirm --repo cachyos-v3 ${packages[*]}"
...
# Test mirror ranking
echo ""
echo "Would run: echo 'y' | cachyos-rate-mirrors"
